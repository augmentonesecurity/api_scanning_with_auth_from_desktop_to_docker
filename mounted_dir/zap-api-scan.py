...
def main(argv):
    ...
    try:
        ...
        zap.script.load('augment1security_accesstoken_setter.py', 'httpsender', 'jython', '/zap/wrk/scripts/httpsender/augment1security_accesstoken_setter.py')
        zap.script.enable('augment1security_accesstoken_setter.py')
        ...
        if not baseline:
            zap_active_scan(zap, target, scan_policy, context_id)
